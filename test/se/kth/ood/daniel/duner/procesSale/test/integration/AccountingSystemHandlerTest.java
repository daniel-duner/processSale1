...
public class AccountingSystemHandlerTest {
	...
	public void testInstatiation() {
		accSys = new AccountingSystemHandler();
		assertTrue("last sale id should be 0",accSys.getLastSaleId() == 0);	
	}
	...
	public void testRegisterCompletedSale() {
		...
		System.out.println(accSys.getNextSaleId());
		assertTrue("last sale id should be 2",accSys.getLastSaleId() == 2);
	}
