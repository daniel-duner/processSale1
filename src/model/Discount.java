...
public class Discount {
	...
	public Discount(double discountGold, double discountSilver, double discountBronze) throws Exception{
		if (checkAllowedDiscountValue(discountGold)||checkAllowedDiscountValue(discountSilver)||checkAllowedDiscountValue(discountBronze)) {
	...
	public void setSingleDiscount(double discount, String membershipLevel) throws Exception{
		...
		case "gold": this.discountGold=discount;
		break;
		case "silver": this.discountSilver = discount;
		break;
		case "bronze": this.discountBronze = discount;
		break;
		}	
	}
	...
	public double getDiscount(String membershipLevel) throws Exception {
		...
		switch(membershipLevel) {
		case "gold": return discountGold;
		case "silver": return discountSilver;
		case "bronze": return discountBronze;
		}
		return 0;
	}
